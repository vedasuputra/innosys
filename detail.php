  ...
  <div class="container">
    <form method="POST" action="" enctype="multipart/form-data">
      ...
      if ($status == 'Pending') {
        ...
        echo '<h4><label for="EditReason" style="color: #041f35!important;">Edit reason of rejection</label></h4>';
      ...
      <?php if ($_SESSION['role'] == 'admin' && $status == 'Pending') {
        ...
        echo '<div class="modal-content">';
        echo '<div class="modal-header">';
        echo '<h4><label for="Reason" style="color: #041f35!important;">Input reason of rejection</label></h4>';
        echo '<div class="close close_multi"><i class=\'bx bx-x\' style="line-height: 0.8"></i></div>';
        echo '</div>';
        echo '<div class="modal-body">';
